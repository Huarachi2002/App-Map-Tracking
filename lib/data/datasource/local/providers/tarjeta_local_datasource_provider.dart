...
import 'package:app_map_tracking/data/datasource/local/tarjeta_local_datasource.dart';
...
final tarjetaLocalDataSourceProvider = FutureProvider<TarjetaLocalDatasource>((ref) async {
  final isar = await ref.watch(isarProvider.future);
  return TarjetaLocalDatasource(isar);
});